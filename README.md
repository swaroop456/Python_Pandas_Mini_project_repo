# 🐍 Python Pandas Mini Project — Cafeteria Sales Data Analysis

## 📌 About This Project
This project was assigned as a mini project by my instructor.
It focuses on *data cleaning, analysis, and visualization* of
Cafeteria Sales Data using Python and Pandas library.
Raw sales data was cleaned, processed, visualized using Matplotlib,
and analyzed to generate meaningful insights including
...
↓
Data Cleaning (Python Pandas Mini Project Script.py)
↓
Cleaned Data (cafe_sales_cleaned.csv)
↓
Visualization — Plot 1 & Plot 2 (Matplotlib)
↓
